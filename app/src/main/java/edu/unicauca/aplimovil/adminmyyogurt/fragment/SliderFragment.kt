...
import edu.unicauca.aplimovil.adminmyyogurt.databinding.FragmentSliderBinding
    ...
    private fun uploadImage(uri: Uri) {
        ...
        refStorage.putFile(uri)
            .addOnSuccessListener {
                it.storage.downloadUrl.addOnSuccessListener {image->storeData(image.toString())
                }
            }
